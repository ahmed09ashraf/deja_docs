    ...
    },
    {
      ...
      "modules": [
        ...
        },
        {
          ...
          "icon": "box",
          "summary": "Log a depot repair. This is what makes the box Damaged or Available.",
          "sections": [
            {
              "heading": "What happens here",
              "type": "text",
              "content": "A container is repaired at a depot. You log that job here: the box, the depot, the day, and the damage lines. The latest job is what Container List uses to show the box as Available or Damaged."
            },
            {
              "heading": "Three different screens",
              "type": "table",
              "columns": [
                "Screen",
                "It is"
              ...
              "rows": [
                ...
                [
                  "Damage List",
                  "The price list you pick a damage from"
                ],
                [
                  "Movement Control",
                  "Moves. This screen writes one only if Hold Move is on"
                ]
              ]
            },
            {
              ...
              "steps": [
                {
                  ...
                  "badge": "STEP 1",
                  "title": "Open the list",
                  "desc": "Container Control → Containers Repairs.",
                  "icon": "box"
                },
                {
                  "step": 2,
                  "badge": "STEP 2",
                  "title": "Find the job",
                  "desc": "Search by container, BL, depot, or date.",
                  "icon": "search"
                },
                {
                  "step": 3,
                ...
                },
                {
                  ...
                  "badge": "STEP 4",
                  "title": "Save the job",
                  "desc": "Container, depot, issue date, damage lines. Tick Hold Move if the box should leave for repair.",
                  "icon": "clipboard"
                },
                {
                  "step": 5,
                  ...
                  "tone": "system",
                  "desc": "Confirm every line and fill the repair date. Until then the box stays Damaged.",
                  "icon": "activity"
                },
                {
                  "step": 6,
                  "badge": "RESULT",
                  "title": "Box is Available",
                  "tone": "result",
                  "icon": "info",
                  "outcomes": [
                    "Received From Repair is created",
                    "Container List shows Available"
                  ]
                }
              ]
            },
            {
              ...
              "type": "rules",
              "items": [
                "Your company only. 30 per page. Newest first.",
                "Search works for container, BL, depot, confirmation (Rejected / Confirmed / Pending / Sold), and the two date ranges.",
                "Created by is on the screen. The search ignores it.",
                "Export downloads the rows you filtered. No rows: \"No data available for export\".",
                "EIR and EOR are hidden on a Sold job, and hidden for Sobek."
              ]
            },
            {
              "heading": "Save, edit, delete",
              "type": "rules",
              "items": [
                "One job per container per issue date. A second one on the same day is rejected.",
                "Edit wipes the damage lines and saves what is on the form.",
                "Photos are added from the list: Before or After. The edit form does not take files.",
                "Delete removes the job, its photos, its lines, and its auto movements.",
                "A container that still has a repair cannot be deleted from Container List."
              ]
            },
            {
              "heading": "Import",
              "type": "rules",
              "items": [
                "Upload the template. One row creates the job header only. No damage lines.",
                "A missing container can be created if the number check digit is valid. The depot must already exist.",
                "Hold Move on a row still sends the box to repair, same as a normal save.",
                "A bad row is skipped and named by row number. Good rows still save."
              ]
            },
            {
              ...
              "type": "rules",
              "items": [
                "Photos live on the list: Before Repair and After Repair.",
                "EIR is the receipt. No prices.",
                "EOR is the estimate. With prices, customer, and payer.",
                "Both PDFs hide when the job is Sold, and for every Sobek company."
              ]
            },
            {
              "heading": "What happens to the box",
              "type": "table",
              "columns": [
                "You do this",
                "What happens"
              ...
              "rows": [
                ...
                [
                  "Hold Move on",
                  "Sent To Repair, on the issue date. The box shows Damaged."
                ],
                [
                  "Every line Confirm, and Repair Date filled",
                  "Received From Repair. The box shows Available."
                ],
                [
                  "Any line still Pending",
                  "The whole job stays Pending. No return movement. The box stays Damaged."
                ],
                [
                  "Is Sold",
                  "Badge says Sold. PDFs hide. The box status does not change."
                ],
                [
                  "Delete the job",
                  "Its Sent To Repair and Received From Repair are removed too."
                ]
              ]
            },
            {
              "heading": "Two things people miss",
              "type": "callout",
              "style": "warning",
              "content": "Confirm the lines and fill the repair date, or the box stays Damaged. This screen does not create an invoice. The cost popup only adds up the lines."
            }
          ]
        },
        {
